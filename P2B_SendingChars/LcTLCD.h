...
#define SetD4_D7Sortida()		(TRISDbits.TRISD3 = TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISDbits.TRISD0 = 0)
#define SetD4_D7Entrada()		(TRISDbits.TRISD3 = TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISDbits.TRISD0 = 1)
