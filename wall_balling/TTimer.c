...
//	IO_SetValue(GPIO_1, 1); // Per comprovar la temportitzaciÛ
...
//	IO_SetValue(GPIO_1, 0); // Per comprovar la temportitzaciÛ
}
//
//---------------------------End--PRIVADES----AREA-----------
//
...
void TiInitTimer () {
    ...
    //TMR0L = 65406;-----------------------------------------------------------------
    //TMR0H = 65406;-----------------------------------------------------------------
	// Activo la interrupciÛ del timer 1
    RCONbits.IPEN = 1;
...
volatile unsigned int actual;
	actual=h_Tics; // indivisible si Ès un int, clar.
